...
module.exports = {
    name: "Facebook",
    desc: "Facebook vidio Downloader",
    category: "Downloader",
    parameters: {
     apikey: { type: "string", example: "skyy" },
     url: { type: "string", example: "https://www.facebook.com/reel/xxx" }
    },       
    ...
    async run(req, res) {
      ...
      try {
        ...
        res.json({ status: false, error: error.message || "Failed to download Facebook video" });
      }
    }
};
