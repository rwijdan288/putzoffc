...
module.exports = {
  name: "Spotify2",
  desc: "Downloader Spotify V2",
  category: "Downloader",
  parameters: {
    apikey: { type: "string", example: "skyy" },
    url: { type: "string", example: "https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT" }
  },     
  path: "/download/spotify2",
  ...
  async run(req, res) {
    ...
    try {
      ...
      Obj.title = trackData.data?.name || "Spotify Track";
