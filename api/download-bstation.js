...
module.exports = {
  name: "Bstation",
  desc: "Download vidio BiliBili/Bstation",
  category: "Downloader",
  parameters: {
    apikey: { type: "string", example: "skyy" },
    url: { type: "string", example: "https://www.bilibili.tv/id/video/xxx" }
  },   
  path: "/download/bstation",
  ...
  async run(req, res) {
    ...
    try {
      ...
      res.json({
        status: false,
        error: err.message || "Failed to process Bstation download"
      });
    }
  }
};
